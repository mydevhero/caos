...
// +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
bool Database::Pool::validateConnection(const std::unique_ptr<pqxx::connection>& connection)
{
...
bool Database::Pool::createConnection(std::size_t& pool_size)
{
  ...
  try
  {
    ...
    auto connection = std::make_unique<pqxx::connection>(this->getConnectStr());
...
// Internal use
void Database::Pool::closeConnection(const std::unique_ptr<pqxx::connection>& connection)
{
